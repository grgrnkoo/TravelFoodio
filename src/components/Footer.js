        ...
        <footer className="w-full text-gray-500 py-6 text-center">
            <div className="container mx-auto px-4">
                ...
                <div className="mt-2 flex flex-col sm:flex-row justify-center items-center space-x-4">
                    ...
                    <div className="flex justify-center items-center space-x-4">
                        <Link href="https://x.com/grgrnkoo" className="text-gray-400 hover:text-white text-sm">Twitter</Link>
                        <span className="text-gray-500">:</span>
                        <Link href="https://linkedin.com/in/oleg-grigorenko-991664117" className="text-gray-400 hover:text-white text-sm">LinkedIn</Link>
                        <span className="text-gray-500">:</span>
                        <Link href="https://t.me/grgrnkoo" className="text-gray-400 hover:text-white text-sm">Telegram</Link>
                    </div>
                </div>
